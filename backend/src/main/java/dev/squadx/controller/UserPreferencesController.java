...
public class UserPreferencesController {
    ...
    public ResponseEntity<ApiResponse<UserPreferencesResponse>> get(
        ...
        return ResponseEntity.ok(ApiResponse.success(preferencesService.get(currentUser)));
    }
    ...
    public ResponseEntity<ApiResponse<UserPreferencesResponse>> update(
        ...
        UserPreferencesResponse response = preferencesService.update(request, currentUser);
