...
public class SpecTaskController {
    ...
    @Operation(summary = "List the append-only audit events of a task")
    public ResponseEntity<ApiResponse<List<dev.squadx.controlpanel.dto.spectask.SpecEventResponse>>> events(
            @PathVariable Long id, @AuthenticationPrincipal User user) {
        return ResponseEntity.ok(ApiResponse.success(specTaskService.getEvents(id, user)));
    }
