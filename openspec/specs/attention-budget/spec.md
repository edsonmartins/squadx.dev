# Spec — attention-budget

Verdade atual. Classificação de eventos/logs de execução por `visibility` e `importance`, para manter
o dashboard legível sob squads (modo silencioso). Realiza ADR-0007, ADR-0002, RFC-0005 §1.
Materializado a partir de `changes/agent-work-governance`.
